          ...
          <div className="mt-4 p-5 rounded-lg border border-slate-200 bg-slate-50">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 text-sm text-slate-700 space-y-3">
                ...
                <details className="bg-white/70 rounded border border-slate-200 p-3">
                  <summary className="cursor-pointer font-semibold">
                    Field Explanations
                  </summary>
                  <ul className="list-disc ml-5 mt-2 space-y-1 text-xs">
                    <li>
                      <strong>Model</strong>: Identifier for the model used.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Journal CID</strong>: IPFS reference to auxiliary
                      data (e.g. keywords).
                    </li>
                    <li>
                      <strong>Proof CID</strong>: Placeholder receipt/proof
                      artifact (not yet verified).
                    </li>
                    <li>
                      <strong>Original Prompt / Generated Output</strong>: Raw
                      texts stored at publication.
                    </li>
                  </ul>
